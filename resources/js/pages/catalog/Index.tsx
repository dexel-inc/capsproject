...
export default function CatalogIndex() {
    ...
    return (
        <>
            <Head>
                <title>Catálogo | Fortune</title>
            </Head>
            <main className="mx-auto max-w-7xl px-4 py-12 sm:py-16">
                <h1 className="text-3xl font-bold tracking-tight text-neutral-900">Catálogo</h1>
                ...
                {products.length === 0 ? (
                    <div className="mt-12 rounded-2xl border border-dashed border-neutral-300 bg-neutral-50/50 py-20 text-center">
                        <p className="text-neutral-500">
                            {initialQ ? 'No hay productos que coincidan con tu búsqueda.' : 'Aún no hay productos en el catálogo.'}
                        </p>
                    </div>
                ) : (
